...
* ***********
    - Functions allows us to easily create a unique solution fro different circumstances by using parameters.
...
/*
    ...
    4. The 'this' keyowrd. 'this' gives us the ability to refer back to whatever called or whatever activates it. In this case, 'this' refers to 'Person'
    ...
    7 & 8: This 'new' keyword is calling out Person function, creating a new person with the vlaues we passing arguements and storing that person in a variable.
