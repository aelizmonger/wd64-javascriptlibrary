...
? FALSY VALUES:
    ...
    Whn JS is expecting a boolean vale and it is returned with one of these six values, it is evaluated as "falsy"
...
if(cookTime === 45){
    ...
    console.log(`It has only been ${cookTime} minutes. Wait anohter 5 - 15 minutes.`)
} else if(cookTime >= 20){
    console.log(`It has only been ${cookTime} minutes. Wait anohter 10 - 25 minutes.`)
} else {
...
// condition ? is true : else result

//    (1)                              (2)                                   (3)      
myName === 'Addy' ? console.log(`Hello, my name is ${myName}.`) : console.log(`Hello, is your name ${myName}?`)
 ...
 * ***********
    ...
    -executesa block of code depending on different cases.
 */
 ...
 switch(instructor) {
     ...
     case 'Josh' :
         ...
         break;
     default:
         console.log(`Sorry, I can't find out what ${instructor} teaches at this time.`)
 ...
 switch(instructor) {
     ...
     case 'Casey':
          ...
          break;
     default:
         console.log(`Sorry, I can't find what ${instructor} teacher.`)
 }